...
const navItems = [
  ...
  { label: 'สนใจเช่า', to: '/admin/rentals', icon: '◇' },
  { label: 'สนใจซื้อ', to: '/admin/sales', icon: '◇' },
  { label: 'ฝากขายทรัพย์', to: '/admin/consignments', icon: '◇' },
  { label: 'อสังหาฯ', to: '/admin/properties', icon: '◇' },
  { label: 'สอบถามจากประกาศ (ซื้อ)', to: '/admin/property-inquiries/sale', icon: '◇' },
  { label: 'สอบถามจากประกาศ (เช่า)', to: '/admin/property-inquiries/rent', icon: '◇' },
